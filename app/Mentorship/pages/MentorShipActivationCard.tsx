...
const MentorshipCard = () => {
  ...
  return (
    <div className="w-full max-w-full md:max-w-4xl lg:max-w-6xl mx-auto p-2 sm:p-6">
      {/* <Card className="relative overflow-hidden bg-gradient-to-br from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 transition-all duration-300 ease-in-out hover:shadow-xl hover:scale-[1.01] sm:hover:scale-[1.02] border border-blue-100 dark:border-blue-900">
            ...
            <div className="px-2 sm:px-14">
              ...
              <div className="flex flex-col space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                  ...
                  <Button
                    variant="default"
                    className="text-white px-3 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm font-medium transition-all duration-200 hover:shadow-lg hover:translate-y-[-2px] active:translate-y-0"
