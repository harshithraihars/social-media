...
//               <div className="w-16 h-16 sm:w-20 sm:h-20 bg-red-500 rounded-full flex items-center justify-center mb-6 mx-auto shadow-lg">
//                 <PhoneOff size={24} className="sm:w-8 sm:h-8 text-white" />
//               </div>
...
//                   setCallDuration(0);
//                 }}
//                 className="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-lg transition-colors duration-200 shadow-lg"
//               >
//                 Start New Call
//               </button>
//             </div>
  ...
  return (
    <div>
      ...
      >
        ...
        {/* Local Video - Picture in Picture */}
        <div className="absolute bottom-10 right-4 sm:bottom-6 sm:right-6 w-32 h-24 sm:w-64 sm:h-48 md:w-80 md:h-60 bg-white rounded-lg overflow-hidden border-2 border-gray-200 shadow-xl">
          <video
            ref={localRef}
            className="w-full h-full object-cover"
            autoPlay
